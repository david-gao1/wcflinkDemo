...
public class StateTest2_KeyedState {
     ...
     * 自定义RichMapFunction
     * <p>
     * MapFunction的变体，它可以访问RuntimeContext并提供设置和拆卸方法
     * <p>
     * 丰富的函数具有用于初始化（ open(Configuration) ）和拆卸（ close() ）的额外方法，
     * 以及通过getRuntimeContext()访问它们的运行时执行上下文
     */
...
//            myMapState.clear();
            ...
            keyCountState.update(++count);//来一条并更新key值并更新到状态中
            return count;
        }
    }
}
